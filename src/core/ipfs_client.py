        ...
        try:
            ...
            for cid, info in result.get('Keys', {}).items():
                ...
                try:
                    ...
                    if 'model_name' in json_content:
                        object_info['model_name'] = json_content['model_name']
            ...
            for obj in objects:
                print(f"CID: {obj['Hash']}, Type: {obj['Type']}, Model ID: {obj.get('model_name', 'N/A')}, Version: {obj.get('version', 'N/A')}")
            return objects
        except Exception as e:
